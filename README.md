...
Automated builds of the image are available on [Docker Hub](https://hub.docker.comryanwclark/mariadb-backup) and is the recommended method of installation.


```bash
docker pull ryanwclark/mariadb-backup
```
...
Along with the Environment Variables from the [Base image](https://hub.docker.com/ryanwclark/alpine), below is the complete list of available options that can be used to customize your installation.
